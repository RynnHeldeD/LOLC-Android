...
public class Constant {
    ...
    private static String CACHE_SERVER_URI = "devtoolbox.fr/?url=";
    ...
    //Default EUW (for all)
    public static String API_CHAMPION_URI = CACHE_SERVER_URI + API_DNS + "api/lol/static-data/euw/v1.2/champion?champData=allytips,altimages,enemytips,image,spells";
