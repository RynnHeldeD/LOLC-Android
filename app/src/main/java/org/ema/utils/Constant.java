...
public class Constant {
    ...
    public static String DDRAGON_SUMMONER_ICON_URI = "http://ddragon.leagueoflegends.com/cdn/5.24.1/img/profileicon/";
    public static String DDRAGON_CHAMPION_ICON_URI = "http://ddragon.leagueoflegends.com/cdn/5.24.1/img/champion/";
    public static String DDRAGON_CHAMPION_SPELL_ICON_URI = "http://ddragon.leagueoflegends.com/cdn/5.24.1/img/spell/";
    public static String DDRAGON_SUMMONER_SPELL_ICON_URI = "http://ddragon.leagueoflegends.com/cdn/5.24.1/img/spell/";
    public static String DDRAGON_ITEMS_ICON_URI = "http://ddragon.leagueoflegends.com/cdn/5.24.1/img/item/";
    public static String DDRAGON_SCOREBOARD_ICON_URI = "http://ddragon.leagueoflegends.com/cdn/5.24.1/img/ui/";
